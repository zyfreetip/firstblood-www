...
web3.version.getNetwork(function(err, version){
  ...
  function clickwrapWatch() {
    ...
    if (((area1.scrollTop() + area1.height()) / area1[0].scrollHeight < 0.99) || ((area2.scrollTop() + area2.height()) / area2[0].scrollHeight < 0.99)) {
      console.log((area1.scrollTop() + area1.height()) / area1[0].scrollHeight, (area2.scrollTop() + area2.height()) / area2[0].scrollHeight);
